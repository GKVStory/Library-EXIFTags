...
depth_file = Path("D:\\_Investigations\\2021-03-24-NavDataExtract-ForImages\\depth.csv")
nav_file = Path("D:\\_Investigations\\2021-03-24-NavDataExtract-ForImages\\nav.csv")
input_directory = Path("D:\\_Investigations\\2021-03-24-NavDataExtract-ForImages\\NIGHT_5M_NANO_LED_4.8ms_3knotl")
output_directory = Path("D:\\_Investigations\\2021-03-24-NavDataExtract-ForImages\\NIGHT_5M_NANO_LED_4.8ms_3knots-withGPS")
...
for i, (in_file, out_file) in enumerate (zip(in_files, out_files)):
    ...
    nav_index = np.searchsorted(nav[:, 0], tags.pps_time)
    ...
    try:
        ...
        tags.altitude_ref = et.ALTITUDEREF_ABOVE_SEA_LEVEL
